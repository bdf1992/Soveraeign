...
function buildPrompt(op) {
  return 'You are a Soveraeign conformance domain builder. Read ' + ROOT + '/AGENTS.md and ' + ROOT + '/STATUS.yaml before editing anything. ' +
    ...
    'If the operation requires a judgement reserved to Bdo, refuse with status refused and refusal_reason instead of deciding. Return operation_id, status, and files_changed.'
}
