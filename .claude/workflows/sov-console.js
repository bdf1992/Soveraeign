...
const plan = await agent(
  ...
  'Current standing: console_service_status is CHARTERED_NOT_IMPLEMENTED. Gates: O18 gates console.ratify_boundary and console.authorize_provisional_human_binding, O2 gates engineering.ratify_baseline, O10 gates spec.ratify. No binding implementation is admitted until the shared transition contract is frozen or Bdo authorizes a provisional target. ' +
