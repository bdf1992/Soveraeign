...
const plan = await agent(
  ...
  'The founding docket is closed: open_decisions is empty and the O<n> identifiers are retired (decisions/0033-close-the-founding-docket.md). Settle a decision at the lowest tier that can produce evidence defeating the alternatives, and record what would defeat the ruling. Only PUBLIC-CLEARANCE and owner-held product intent, public naming, external commitment, irreversible external effect, secrets, and destructive repository administration reach Bdo, and his gate is acceptance over an evidenced result, never permission to begin. Current standing: proofing_service_status is RULED_SECOND_BOUNDARY_O11_CHARTERED_NOT_IMPLEMENTED. Proofing is the second service boundary after Asset at chartered standing, held as a reversible default and not as owner acceptance (decisions/0046-decision-queue-drain.md, O11, which states that none of its rulings is one); it references exact Asset versions and never becomes payload custody or a second asset authority. The counter that overturns O11 is a conformance case showing the proofing lifecycle is the asset lifecycle renamed. What is missing is the contract and its defeating fixtures. ' +
