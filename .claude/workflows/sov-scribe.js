...
const framePrompt = 'Read .claude/skills/sov-scribe/SKILL.md, then normalize this writing request against its request template. Request: ' + requestText + '. '
  ...
  + 'Set blocked true only when drafting cannot proceed honestly without the missing answers; a missing owner answer that only gates acceptance is a default to take and name, not a block.'
