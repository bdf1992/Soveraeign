...
const plan = await agent(
  ...
  'This workflow's execution envelope is limited to RECORD_LOCAL and RESOURCE_CONSUMPTION; do not plan EXTERNAL_WORLD work here. That is a local workflow ceiling, not a phase-wide authority rule. Evidence files under lineage/evidence/ are immutable. ' +
