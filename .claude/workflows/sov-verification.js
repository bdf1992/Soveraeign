...
const buildThunks = plan.operations.map(function (op) {
  return function () {
    return agent(
      ...
      'You must NOT run git commit or git push; leave changes in the working tree. You emit a build report only - you cannot witness or ratify your own work. Queue judgement-typed questions for Bdo instead of deciding them. ' +
