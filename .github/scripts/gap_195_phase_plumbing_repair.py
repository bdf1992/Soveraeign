...
# The generic reader knows how to discover contracts/custodies/*.json once an
# opening act creates one, but the verifier must not require that future phase
# directory to exist while STATUS still says NONE_ACTIVE.
