# 0105 · The landing grant admits prose it cannot land
...
```
clarity-covered artifacts:                152
of those, inside the grant's scope:       113
  services 53 · .claude 44 · bindings 5 · adapters 4 · contracts 3 ·
...
So for those 113 artifacts the grant is in a deadlock of its own making: land the
...
2. **Leave the grant as it is** and accept that changes to those 113 artifacts
...
- Evidence that the 113 figure is an artifact of the current coverage file
