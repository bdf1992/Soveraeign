...
def _balanced_from(code: str, start: int, opener: str, closer: str) -> int:
...
def blocks(source: str, name: str) -> list[str]:
    ...
    elements, _separator, tail = parsed
    ...
    return [_literals(part) for part in elements]
