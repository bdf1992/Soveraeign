...
def _balanced(code: str, start: int, opener: str, closer: str) -> int:
    ...
    Here rather than in a reader, because which bracket closes which is exactly the kind
    of question five readings have now defeated this package for answering twice.
    """
    index, depth = start, 0
