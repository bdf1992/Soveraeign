...
#: Checks whose only way to fail is wrong behaviour; the rest keep the main-gate default.
_DEV_GATE = frozenset({
    "repository hygiene", "status claim refusals fire", "owner queue", "asset object cases",
    "bootstrap and locked evidence", "conformance oracle controls", "conformance oracle tests",
    "kernel transition contract", "kernel participant parity", "service manifest contract",
    "receipt event vocabulary", "phase progress floor", "semantic cold-start task",
    "participant against its baseline", "ticket contract corpora", "closure ownership",
    "standing authority grants", "node registry", "Sov context profile", "local model adapter",
    "Record Service independent witness", "Kernel binding closure", "repository tooling tests",
})
