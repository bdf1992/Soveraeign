...
the two roots diverge again. The second is the whole suite, run as a subprocess against
this checkout, asserting the operational ledger's bytes do not move - which is the property
that was actually violated and the one a mechanism test alone would not have caught.
"""
