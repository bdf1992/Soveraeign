...
CHECKS = (
    ...
    ("infrastructure manifest", [sys.executable, "scripts/infrastructure.py", "validate"], ROOT),
    ("deployment topology", [sys.executable, "scripts/deployment.py", "validate"], ROOT),
    ("infrastructure, deployment, and lint defeating tests", [sys.executable, "-m", "unittest", "discover", "-s", "scripts/tests", "-v"], ROOT),
