...
| `observation/` | thin slice built and self-tested, not witnessed since decisions/0104 replaced its walk; remainder declared | independent observation: observer registrations, declared predicates, observation requests, independence checks, observations, and attestations. Not the log - the journal is the Record Service's |
